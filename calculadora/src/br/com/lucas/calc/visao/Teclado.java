...
public class Teclado extends JPanel implements ActionListener {
	...
	private final Color COR_CINZA_ESCURO = new Color(68, 68, 68); //Para definir as cores
	...
	public Teclado() {
		...
		/*Configuração de propriedades do GridBagConstraints para controlar
		*o tamanho e preenchimento dos componentes.*/
		...
		/*Adiciona botões à interface, especificando o texto, a cor,
		*as restrições (c), a posição x e y.*/

		// Linha 1
		c.gridwidth = 2; //Para dizer o espaço que vai ser ocupado
	...
	@Override
	public void actionPerformed(ActionEvent e) { //Para gravar os textos dos botoes
